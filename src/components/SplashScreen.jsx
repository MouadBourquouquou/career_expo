    ...
    >
      ...
      >
        ...
        >
          <motion.h1
            style={{
              ...
              background: 'linear-gradient(135deg, var(--text), #4494E4)',
        ...
        <motion.div
          ...
          style={{
            height: '2px',
            background: 'linear-gradient(90deg, #4494E4, var(--text))',
            borderRadius: '1px',
            marginTop: '1rem'
          }}
        />
      ...
      {[...Array(6)].map((_, i) => (
        <motion.div
          ...
          style={{
            ...
            width: '4px',
            height: '4px',
            background: i % 2 === 0 ? '#4494E4' : 'var(--text)',
            borderRadius: '50%',
            top: '60%',
            left: `${45 + i * 2}%`
          }}
